...
#
# Script generated by Vivado on Wed Jul 01 13:45:44 +0800 2026
# SW Build 6140274 on Thu May 22 00:12:29 MDT 2025
#
# Copyright 1986-2022 Xilinx, Inc. All Rights Reserved.
# Copyright 2022-2025 Advanced Micro Devices, Inc. All Rights Reserved. 
#
# Filename     : STLB_comparison.sh
...
#
# Usage        : STLB_comparison.sh
#                STLB_comparison.sh [-lib_map_path] [-step] [-keep_index] [-noclean_files]*
#                STLB_comparison.sh [-reset_run]
#                STLB_comparison.sh [-reset_log]
#                STLB_comparison.sh [-help]
#
...
export RDI_DATADIR="E:/exe/vivado/2025.1/Vivado/data"

# set xvlog options
xvlog_opts="--incr --relax "

# script info
echo -e "STLB_comparison.sh - Script generated by export_simulation (Vivado v2025.1 (64-bit)-id)\n"
...
run()
{
  ...
  if [[ ($b_step == 1) ]]; then
    case $step in
      ...
      ;;
      * )
        echo -e "ERROR: Invalid or missing step '$step' (type \"./STLB_comparison.sh -help\" for more information)\n"
        exit 1
      esac
  else
    init_lib
...
elaborate()
{
  xelab --incr --debug typical --relax --mt 2  -L xil_defaultlib -L blk_mem_gen_v8_4_11 -L unisims_ver -L unimacro_ver -L secureip -L xpm --snapshot STLB_comparison xil_defaultlib.STLB_comparison xil_defaultlib.glbl -log elaborate.log
}

# RUN_STEP: <simulate>
simulate()
{
  xsim STLB_comparison -key {Behavioral:sim_1:Functional:STLB_comparison} -tclbatch cmd.tcl -log simulate.log
}
...
copy_setup_file()
{
  ...
  if [[ ($lib_map_path == "") ]]; then
    lib_map_path="E:/exe/vivado/2025.1/Vivado/data/xsim"
  fi
...
reset_run()
{
  files_to_remove=(xelab.pb xsim.jou xvhdl.log xvlog.log compile.log elaborate.log simulate.log xelab.log xsim.log run.log xvhdl.pb xvlog.pb STLB_comparison.wdb xsim.dir libdpi.so)
...
check_arg_value()
{
  ...
  if [[ ($1 == "-lib_map_path") && ($2 == "") ]];then
    echo -e "ERROR: Simulation library directory path not specified (type \"./STLB_comparison.sh -help\" for more information)\n"
    exit 1
  fi
}
...
usage()
{
  msg="Usage: STLB_comparison.sh [-help]\n\
Usage: STLB_comparison.sh [-step]\n\
Usage: STLB_comparison.sh [-lib_map_path]\n\
Usage: STLB_comparison.sh [-reset_run]\n\
Usage: STLB_comparison.sh [-reset_log]\n\
Usage: STLB_comparison.sh [-keep_index]\n\
Usage: STLB_comparison.sh [-noclean_files]\n\n\
