...
#                script (type 'STLB_comparison.sh -help' for more information).
#
...
map_setup_file()
{
  ...
  if [[ ($lib_map_path == "") ]]; then
    lib_map_path="E:/exe/vivado/project/nostalgia_LA64/nostalgia_LA64.cache/compile_simlib/activehdl"
  fi
  if [[ ($lib_map_path != "") ]]; then
