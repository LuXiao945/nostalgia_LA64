...
#
# Script generated by Vivado on Wed Jul 08 14:19:39 +0800 2026
# SW Build 6140274 on Thu May 22 00:12:29 MDT 2025
#
# Copyright 1986-2022 Xilinx, Inc. All Rights Reserved.
# Copyright 2022-2025 Advanced Micro Devices, Inc. All Rights Reserved. 
#
# Filename     : CacheLine.sh
...
#
# Usage        : CacheLine.sh
#                CacheLine.sh [-lib_map_path] [-step] [-keep_index] [-noclean_files]*
#                CacheLine.sh [-reset_run]
#                CacheLine.sh [-reset_log]
#                CacheLine.sh [-help]
#
...
# script info
echo -e "CacheLine.sh - Script generated by export_simulation (Vivado v2025.1 (64-bit)-id)\n"
...
run()
{
  ...
  if [[ ($b_step == 1) ]]; then
    case $step in
      ...
      ;;
      * )
        echo -e "ERROR: Invalid or missing step '$step' (type \"./CacheLine.sh -help\" for more information)\n"
        exit 1
      esac
  else
    init_lib
...
elaborate()
{
  xelab --incr --debug typical --relax --mt 2  -L xil_defaultlib -L blk_mem_gen_v8_4_11 -L unisims_ver -L unimacro_ver -L secureip -L xpm --snapshot CacheLine xil_defaultlib.CacheLine xil_defaultlib.glbl -log elaborate.log
}

# RUN_STEP: <simulate>
simulate()
{
  xsim CacheLine -key {Behavioral:sim_1:Functional:CacheLine} -tclbatch cmd.tcl -log simulate.log
}
...
reset_run()
{
  files_to_remove=(xelab.pb xsim.jou xvhdl.log xvlog.log compile.log elaborate.log simulate.log xelab.log xsim.log run.log xvhdl.pb xvlog.pb CacheLine.wdb xsim.dir libdpi.so)
...
check_arg_value()
{
  ...
  if [[ ($1 == "-lib_map_path") && ($2 == "") ]];then
    echo -e "ERROR: Simulation library directory path not specified (type \"./CacheLine.sh -help\" for more information)\n"
    exit 1
  fi
}
...
usage()
{
  msg="Usage: CacheLine.sh [-help]\n\
Usage: CacheLine.sh [-step]\n\
Usage: CacheLine.sh [-lib_map_path]\n\
Usage: CacheLine.sh [-reset_run]\n\
Usage: CacheLine.sh [-reset_log]\n\
Usage: CacheLine.sh [-keep_index]\n\
Usage: CacheLine.sh [-noclean_files]\n\n\
